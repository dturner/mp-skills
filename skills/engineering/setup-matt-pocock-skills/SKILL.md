...
- **Issue tracker** — where issues live (GitHub by default; Beads and local markdown are also supported out of the box)
...
- **Beads** - issues live in the repo's Beads database (uses the [`bd`](https://github.com/gastownhall/beads) CLI)
